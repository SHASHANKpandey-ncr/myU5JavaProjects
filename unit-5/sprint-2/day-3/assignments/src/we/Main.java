...
class Common{
	...
	//without static, only with synchronized =  object level lock
...
// only synchronized keyword in front of method will provide 
...
//level lock by providing static synchronized keyword in front of 
//method
